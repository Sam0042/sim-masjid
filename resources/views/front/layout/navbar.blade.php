...
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary sticky-top">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!-- Left links -->
            <ul class="navbar-nav  mb-2 mb-lg-0 mx-auto d-flex justify-content-between gap-3">
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item" href="#">Waktu Sholat</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#">Imam 5 Waktu</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#">Imam Jum'at</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    {{-- <a class="nav-link" href="{{ route('galeri.create') }}">Galeri</a> --}}
